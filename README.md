...
Unidade 1: Introdução à Aplicações Móveis

1.1 - Evolução histórica dos componentes de hardware e software

1.2 - Plataformas de desenvolvimento de aplicações móveis

Unidade 2: Programação de Aplicativos Móveis

2.1 - Projetos de aplicações móveis

2.2 - Linguagens de programação para dispositivos móveis

Unidade 3: Persistência de Dados em Aplicações Móveis

3.1 - Manipulação de arquivos

3.2 - Manipulação de banco de dados local e remotos

Unidade 4: APIs e Frameworks

4.1 - APIs de requisições web

4.3 - APIs de mecanismos de buscas, redes sociais e armazenamento remoto.
